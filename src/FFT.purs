module FFT (FFT, ComplexArray(..), RealArray(..), newFFT, size, fromComplexArray, createComplexArray, toComplexArray, transform, realTransform, inverseTransform, STComplexArray(..), STRealArray(..), fromComplexArrayST, toComplexArrayST, transformST, realTransformST, inverseTransformST) where
